...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="actions/BuscarEstacionamiento.jsp" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Ejemplo: Av. Concha y Toro 1340, Puente Alto" name="txtDireccion">
